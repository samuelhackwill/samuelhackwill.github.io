...
var textStrings_FR = {
    ...
    "outtaHere"            : "oui c'est ça allez ouste",
    "getARoom"             : "DÉGOÛTANT, Y'A DES HÔTELS POUR ÇA",
    "notCoolAnymore"       : "meh finalement les chapeaux c'est ringard",
    ...
    // Act 3
    "ellipsis"             : ". . ."                                                                ,
    "coolNoMore"           : "les chapeaux ne sont plus à la mode, vous n'étiez pas au courant?"           ,
    "beScared"             : "SOYEZ TERRIFIÉS, SOYEZ EN COLÈRE."                                      ,
    ...
    // (chyron3.png)
    "chyronNothing"      : "WAAAA, *RIEN DU TOUT*" ,
    ...
    // (credits000[3,4,5,6].png)
    "patreonSupporters"  : "et à mes soutiens sur Patreon:" ,
    ...
    "buyCoffeeButton"    : "payez moi un café" ,
    "replayButton"       : "rejouer à ce truc" ,
    ...
    // (quote0002.png)
    "WBWWB"              : "We become what we behold." ,
    "WSOTATOTSU"         : "Nous fabriquons des outils, et ensuite ces outils nous fabriquent à leur tour." ,
    
    // (quote0003.png)
    "MarshallMcLuhan"    : "Marshall McLuhan" ,
    
    // (quote0004.png)
    "misatrributed"      : "(en tout cas ça pourrait être de lui)" ,
